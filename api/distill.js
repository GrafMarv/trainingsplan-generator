  ...
  if ((req.body || {}).modus === 'plan') {
    try {
      ...
      const prompt = [
        ...
        '   name-mit-bindestrichen_kategorie_subkategorie_merkmal_dynamik\n   Der vorschlagName ist der Name aus dem Plan, unveraendert und in der Sprache des Plans.\n   Der vorschlagKey wird daraus abgeleitet, klein und mit Bindestrichen.',
        '   Kategorien: strength, mobility, sprint, jump, agility, misc',
        '',
        'REGELN',
        '- GRUNDSATZ: Der Name aus dem Plan gilt. Du ersetzt ihn NICHT durch eine Uebung, die du fuer sinnvoller oder trainingswissenschaftlich besser haeltst. Deine Aufgabe ist Abbilden, nicht Verbessern.\n- Eine Zuordnung ist nur erlaubt, wenn es DIESELBE BEWEGUNG ist. Pruefe: gleiche Ausgangsposition, gleicher Bewegungsablauf, gleiches Geraet, gleiche Seitigkeit. Weicht eines davon ab, ist es NICHT dieselbe Uebung.\n- Aehnliche Muskulatur oder aehnlicher Trainingszweck reicht ausdruecklich NICHT.\n- Zusaetze im Bestandsnamen wie kettlebell, dumbbell, barbell, band, cable, box, deficit, bulgarian, single-leg bedeuten eine andere Uebung, wenn der Plan sie nicht nennt. Steht im Plan nur "Kniebeuge", ist "goblet-squat-kettlebell" FALSCH. Gibt es kein schlichtes "squat" im Bestand, lege "Kniebeuge" neu an.\n- Steht im Plan ein Zusatz wie "mit Gewicht", "wenn moeglich mit Gewicht", "diagonal strecken", "mit Rotation", "Augen geschlossen", gehoert dieser in note und macht daraus KEINE andere Uebung.\n- Deutsche Plannamen und englische Bestandsnamen duerfen zugeordnet werden, wenn es dieselbe Bewegung ist. Beispiele fuer echte Gleichheit: Unterarmstuetz = plank, Seitstuetz = side-plank, Ausfallschritt = lunge, Liegestuetz = push-up, Standwaage = single-leg-deadlift ohne Gewicht.\n- Beispiele fuer FALSCHE Zuordnungen, die du nicht machen darfst: Unterarmstuetz zu bird-dog, Kniebeuge zu goblet-squat-kettlebell, Schwimmer zu back-extension, Standwaage zu romanian-deadlift.\n- Im Zweifel immer neu anlegen. Eine zusaetzliche Uebung im Bestand ist harmlos, eine falsche Zuordnung verfaelscht den Plan dauerhaft.\n- sicherheit ist "hoch" nur bei woertlicher oder eindeutiger Uebersetzungsgleichheit, sonst "mittel" oder "niedrig".',
        ...
        '- Uebernimm Hinweise aus dem Original moeglichst woertlich in note.\n- ZIRKEL: Steht ueber einem Abschnitt eine Rundenangabe wie "4 Runden", "3 Durchgaenge" oder "3x alles", dann gilt sie fuer ALLE Uebungen dieses Abschnitts. Setze dann zirkel=true am Block und sets = Rundenzahl bei jeder Uebung des Blocks. Die Uebungen werden nacheinander durchlaufen, nicht satzweise.\n- Ohne Rundenangabe ist zirkel=false und jede Uebung hat ihre eigene Satzzahl.',
        '',
        ...
        '  "blocks": [',
        '    { "type": "warmup" oder "main", "label": "Blockname", "zirkel": true/false, "runden": 4,',
        '      "slots": [',
